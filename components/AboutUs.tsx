        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <AnimatedSection delay={150}>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-light-text dark:text-white">About Cashlio Finance</h2>
              ...
              <p className="text-light-text-secondary dark:text-gray-300 mb-4 leading-relaxed">
                At Cashlio Finance, we are driven by a single mission: to democratize finance and make sophisticated investment strategies accessible to everyone. We believe that financial growth should not be limited to the privileged few.
              </p>
