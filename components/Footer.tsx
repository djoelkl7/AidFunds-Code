            ...
            <ul>
              <li className="mb-2">
                <AnimatedSection delay={200}>
                  <Link to="/about" className="hover:text-primary-red transition-colors duration-300">About Us</Link>
                </AnimatedSection>
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                <AnimatedSection delay={300}>
                  <Link to="/contact" className="hover:text-primary-red transition-colors duration-300">Contact</Link>
                </AnimatedSection>
              </li>
              <li>
